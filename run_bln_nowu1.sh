...
CUDA_VISIBLE_DEVICES=$CUDA python3 train.py $DATA_PATH  \
    --seed $SEED \
...
CUDA_VISIBLE_DEVICES=$CUDA python3 scripts/average_checkpoints.py --inputs $OUTPUT_PATH \
  --num-epoch-checkpoints 10 --output $OUTPUT_PATH/avg_10.pt
   
CUDA_VISIBLE_DEVICES=$CUDA python3 generate.py $DATA_PATH \
